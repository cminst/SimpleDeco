...
# from nemo.collections.llm import DeepSeekV3Config, DeepSeekModel
from nemo.collections.llm import Qwen3Model, Qwen3Config235B_A22B, Qwen3Config30B_A3B
...
@dataclass
class AutoDecoQwen3Config235BA22B(Qwen3Config235B_A22B):
...
@dataclass
class AutoDecoQwen3Config30BA3B(Qwen3Config30B_A3B):
    train_temp_head: bool = field(default=True)
    train_top_p_head: bool = field(default=False)
    output_hidden_states: bool = field(default=False)
    model_head_path: str = field(default="")
...
class AutoDecoQwen3ModelNeMo(Qwen3Model):
    def __init__(
            self,
            config: Annotated[Optional[AutoDecoQwen3Config30BA3B], Optional[AutoDecoQwen3Config235BA22B]] = None,
    ...
    def configure_model(self, vp_stage: Optional[int] = None) -> None:
        ...
        if parallel_state.is_pipeline_last_stage() and first_configure and not hasattr(self.module, "temp_head"):
            ...
            if vps is None or vp_stage is None or vp_stage == vps - 1:
                ...
                save_file(tensors=adapter.state_dict(), filename="/root/empty_qwen3_head.safetensors")
...
@io.model_exporter(AutoDecoQwen3ModelNeMo, "hf-peft")
class HFAutoDecoQwen3ModelExporter(io.ModelConnector[AutoDecoQwen3ModelNeMo, "AutoModelForCausalLM"]):
