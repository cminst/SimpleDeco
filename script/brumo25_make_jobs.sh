...
DATASET="brumo25"
JOB_FILE="${JOB_FILE:-$ROOT_DIR/jobs/brumo25_jobs.txt}"
APPEND="${APPEND:-0}"
...
TAG_MEANSHIFT="meanshift-0.798-0.85-r1-distill-qwen7b"
...
# 4) Meanshift: all 8 seeds with adjusted temp/top-p.
emit_eval_jobs "$TAG_MEANSHIFT" "$MODEL_BASE" 0.798 0.85 "maj@k" 16
