...
DATASET="aime24"
JOB_FILE="${JOB_FILE:-$ROOT_DIR/jobs/aime24_gptoss20b_jobs.txt}"
APPEND="${APPEND:-0}"
...
# 4) Alternate Meanshift: all 16 seeds.
emit_eval_jobs "$TAG_MEANSHIFT_ALT" "$MODEL_BASE" "$MEANSHIFT_ALT_TEMP" "$MEANSHIFT_ALT_TOP_P" "$NUM_SAMPLES"
