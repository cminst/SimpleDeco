...
JOB_FILE="${JOB_FILE:-$ROOT_DIR/jobs/llama_nemotron_jobs.txt}"
APPEND="${APPEND:-0}"
FILTER_EXISTING="${FILTER_EXISTING:-1}"
RESULT_ROOT="${RESULT_ROOT:-ckpt_nemotron}"
MODEL_BASE="${MODEL_BASE:-ckpt/Llama-Nemotron-8B}"
MODEL_AUTODECO="${MODEL_AUTODECO:-ckpt/AutoDeco-Llama-Nemotron-8B-Merged}"
...
BASE_TEMP="${BASE_TEMP:-0.6}"
BASE_TOP_P="${BASE_TOP_P:-0.95}"
AUTODECO_TEMP="${AUTODECO_TEMP:-1.0}"
AUTODECO_TOP_P="${AUTODECO_TOP_P:-1.0}"
MEANSHIFT_TEMP="${MEANSHIFT_TEMP:-0.761}"
MEANSHIFT_TOP_P="${MEANSHIFT_TOP_P:-0.813}"
