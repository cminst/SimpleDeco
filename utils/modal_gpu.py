...
image = (
    ...
    .run_commands(
        ...
        "uv pip install accelerate trl==0.22.0 deepspeed orjson hf_transfer setuptools==80.10.2 setuptools_scm --torch-backend=cu128 --system",
